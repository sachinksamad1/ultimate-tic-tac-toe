...
<div class="creator-info">
  <p>{$t('createdBy')} <span class="name">Sachin K Samad</span></p>
  <div class="links">
    <div class="social-links">
      <a
        href="https://github.com/sachinksamad1"
        target="_blank"
      ...
      <a
        href="https://www.linkedin.com/in/sachin-s-710292376/"
        target="_blank"
        rel="noopener noreferrer"
        title="LinkedIn"
      >
    ...
    <a
      href="https://github.com/sachinksamad1/ultimate-tic-tac-toe"
      target="_blank"
      rel="noopener noreferrer"
      class="repo-link"
    >
